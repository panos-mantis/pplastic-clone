...
(function () {
  ...
  var I18N = {
    en: {
      ...
      "sub.check.material": "Extruded in durable PVC",
      "sub.check.colours": "A range of profiles and colours",
      "sub.check.lengths": "Supplied in coils or cut lengths",
      "sub.check.custom": "Custom sections to your sample or drawing",
      "rubrails.fig.usection": "Profile drawing — U-section with T insert (45 × 34 mm)",
      "heavyduty.fig.dfender": "D-fender heavy-duty profile",
    ...
    el: {
      ...
      "sub.check.material": "Εξώθηση σε ανθεκτικό PVC",
      "sub.check.colours": "Ποικιλία προφίλ και χρωμάτων",
      "sub.check.lengths": "Διάθεση σε ρολά ή σε μήκη κοπής",
      "sub.check.custom": "Ειδικά προφίλ βάσει δείγματος ή σχεδίου",
      "rubrails.fig.usection": "Σχέδιο προφίλ — διατομή U με ένθετο T (45 × 34 mm)",
      "heavyduty.fig.dfender": "Προφίλ D-fender βαρέως τύπου",
